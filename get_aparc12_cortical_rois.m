...
stutFL_roiSet_fn = '/users/cais/STUT/scripts/activROIs_uc.mat';


if nargin >= 1 && isequal(varargin{1}, 'speech')
    roi_names = speech_roi_names;
elseif nargin >= 1 && ...
       (isequal(varargin{1}, 'speech_PFS_lh') || ...
        isequal(varargin{1}, 'speech_PFS_rh') || ...
        isequal(varargin{1}, 'speech_PWS_lh') || ...
        isequal(varargin{1}, 'speech_PWS_rh') || ...
        isequal(varargin{1}, 'speech_2g_lh') || ...
        isequal(varargin{1}, 'speech_2g_rh'))
    idxus = strfind(varargin{1}, '_');
    t_grp = varargin{1}(idxus(1) + 1 : idxus(2) - 1);
    t_hemi = varargin{1}(idxus(2) + 1 : end);
